...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Zaposleni</h1>
            ...
            <?php
                    ...
                    ?>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Zaposleni</h6>
                            </div>
                            <div class="card-body">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Obriši radnika</h5>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" data-id = "<?php echo $employee['employee_id']; ?>" class="btn btn-danger delete_employee_bttn">Obriši</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Dodaj novog radnika</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="employees.php?do=Add">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_phone">Broj telefona</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_phone']))?htmlspecialchars($_POST['employee_phone']):'' ?>" placeholder="Broj telefona" name="employee_phone">
                                            <?php
                                                if(isset($_POST['add_new_employee']))
                                                {
                                    ...
                                    try
                                    {
                                        ...
                                        ?> 
                                            ...
                                            <script type="text/javascript">
                                                swal("Novi Radnik!","Uspešno ste dodali novog radnika!", "success").then((value) => 
                                                {
                ...
                elseif($do == 'Edit')
                {
                    ...
                    if($employee_id)
                    {
                        ...
                        if($count > 0)
                        {
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Promeni zaposlenog</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $employee['phone_number'] ?>"  placeholder="Broj telefona" name="employee_phone">
                                                    <?php
                                                        if(isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if(empty(test_input($_POST['employee_phone'])))
                                        ...
                                        if(isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_employee_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                ?> 
                                                    ...
                                                    <script type="text/javascript">
                                                        swal("Izmenili ste zaposlenog","Uspešno promenjeno", "success").then((value) => 
                                                        {
                                                            window.location.replace("employees.php");
                                                        });
                                                    </script>
