                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Lista nadolazećih termina";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
                                                ...
                                                echo "<td>";
                                                	$cancel_data = "cancel_appointment_".$row["appointment_id"];
                                               		...
                                               		<ul class="list-inline m-0">
                                                        ...
                                                        <li class="list-inline-item" data-toggle="tooltip" title="Otkaži termin">
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Otkaži šišanje</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p>Da li ste sigurni da želite da otkažete šišanje?</p>
