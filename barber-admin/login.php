...
<html lang="en">
	<head>
		...
		<title>Barbershop Igor 96 Admin Login</title>
		<!-- FONTS FILE -->
		...
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
				<span class="login100-form-title p-b-32">
					Barbershop Igor 96 Admin Login
				</span>
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						else
						{
							...
							<div class="alert alert-danger">
								...
								<div class="messages">
									<div>Ime ili lozinka netačno upisano.</div>
								</div>
							</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_username">Ovo polje je obavezno!</span>
				</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_password">Ovo polje je obavezno!</span>
				</div>
				
				<!-- SIGN IN BUTTON -->

				<p>
					<button type="submit" name="signin-button" >Prijavi se</button>
				</p>

				<!-- FORGOT YOUR PASSWORD LINK -->

				<span class="forgotPW">Zaboravili ste šifru ? <a href="#">Promeni ovde</a></span>
			</form>
		</div>
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Barbershop Website by JOVAN PRODANIC</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
